...
{{-- Fix: on mobile both sides had min-width:250px totalling 500px+ on a 375px screen --}}
<style>
@media (max-width: 991.98px) {
    .header-left,
    .header-right { min-width: unset !important; }
}
</style>
...
<header class="sticky-top bg-primary-subtle shadow-sm" style="height: 56px;">     
    <div class="d-flex justify-content-between align-items-center h-100 {{ ConfProvider::from(Module::USER_INFE)->large_screen_nav_style === 'minibar' ? 'pe-2' : 'pe-1' }}">
        ...
        {{-- Added class header-left --}}
        <div class="d-flex align-items-center py-2 header-left" style="min-width: 250px">
        ...
        {{-- Added class header-right --}}
        <div class="d-flex align-items-center justify-content-end gap-2 header-right" style="min-width: 250px">     
